        ...
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
            ...
            <form action="" name="form1" enctype="multipart/form-data" method="post">
                ...
                if (isset($_POST['submit'])) {
                    ...
                    move_uploaded_file($_FILES["file"]["tmp_name"], "../register/uploads/$image");

                    $q = "update user set firstname = '$firstName',lastname = '$lastName',gender = '$gender',mobile = '$mobile',district = '$district',
                    state = '$state', image = '$image' where email = '$email'";
                    mysqli_query($con, $q);
                    echo $q;


                     echo "<script> alert('User modified successfully'); window.location='editProfile.php'</script>";
                }
                ?>
                ...
                while ($row = mysqli_fetch_array($sql)) {
                    ...
                    <div class="row1" style="margin-top:200px" >                 
                        <div class="colum1">First Name</div>
                        <div class="colum2"> <input type="text" name="fname" class="av-name"  style=" color: black !important;" av-message="invalid format" value=" <?php echo $row[1] ?>" />
                        </div>
                    </div>
                    <div class="row1">
                        <div class="colum1">Last Name</div>
                        <div class="colum2"> <input type="text" name="lname" class="av-name" style=" color: black !important;"  av-message="invalid format" value=" <?php echo $row[2] ?>" />
                        <input type="hidden" name="email" class="av-name" style=" color: black !important;"  av-message="invalid format" value="<?php echo $row[3] ?>"></div>
                    </div>

                    <div class="row1" >
                        <div class="colum1">Gender</div>
                        <div class="colum2">
                            <select id="gender" name="gender" style=" color: black !important;" >
                                <option value="Male"><?php echo $row[4] ?></option>
                                <option value="Male" style=" color: black !important;" >Male</option>
                                <option value="Female" style=" color: black !important;" >Female</option>
                                <option value="Others" style=" color: black !important;" >Others</option>
                            </select></div>
                    </div>
                    <div class="row1">
                        <div class="colum1">Mobile</div>
                        <div class="colum2"><input type="mob" name="mobile" class="av-mobile" value=" <?php echo $row[5] ?>" style=" color: black !important;"  av-message="invalid format" />
                        </div>
                    </div>
                    <div class="row1">
                        <div class="colum1">State</div>
                        <div class="colum2"><select id="state" name="state" style=" color: black !important;"  onchange="document.getElementById('text_content').value=this.options[this.selectedIndex].text">
                    ...
                    <div class="row1">
                        ...
                        <div class="colum2"> <img src=" ../register/uploads/<?php echo $row[8]?>" alt="avathar" class="avathar">
                        <input type="file" name="file" id="fileToUpload" value="<?php echo $row[8] ?>" class="av-image" /></div>
                    </div>
                    <div class="row1">
