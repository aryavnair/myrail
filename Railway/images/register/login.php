...
if (isset($_POST['submit'])) {
  ...
  if ($count == 0) {
    ...
    echo "<script> alert('User Already registered please login'); window.location='login.php'</script>";
  }
      ...
      <div class="tab-content">
        <div id="signup">   
          ...
          <div class="field-wrap">
            ...
            <input type="text" name="email" onblur="validate Email(this);"/>
          </div>
...
function validateEmail(email){
        ...
        if (login.test(email.value) == false) 
        {
...
if(!isNaN(document.form1.gender.value))
{
