...
<body>
    <ul>
        ...
        <li class=""><a href="reservation.php" class="nav-link">Reservation</a></li>
...
<table width="50%0" align="center" border="1">
  ...
  <?php for ($i = 0; $i < $adult; $i++) {
    ...
    echo "<tr><td> <input type='text' name='pname$i' id=''></td><td><input type='text' name='age$i' id=''></td><td><select class='select-css control' name='gender$i' id=''>
        <option >Male</option>
